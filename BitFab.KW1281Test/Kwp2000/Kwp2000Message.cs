...
namespace BitFab.KW1281Test.Kwp2000
{
    public class Kwp2000Message
    {
        ...
        public Kwp2000Message(DiagnosticService service, IList<byte> body)
        {
        ...
        public Kwp2000Message(byte destAddress, byte srcAddress, DiagnosticService service, IList<byte> body)
        {
        ...
        public Kwp2000Message(byte formatByte, byte? destAddress, byte? srcAddress, byte? lengthByte,
            DiagnosticService service, IList<byte> body, byte checksum)
        {
