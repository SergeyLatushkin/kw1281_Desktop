...
namespace BitFab.KW1281Test.Cluster
{
    class BoschRBxCluster : ICluster
    {
        ...
        public bool SecurityAccess(byte accessMode)
        {
            ...
            Mc.AddLine(Utils.DumpAscii(responseMsg.Body.Skip(1)));
        ...
        public bool ToggleRB4Mode()
        {
            ...
            {
                Mc.Add("Cluster is not an Audi cluster!");
                return false;
            }
            else
            {
                try
                {
                    ...
                    Mc.Add("Cluster is in New mode (4).");
                }
                catch (NegativeResponseException)
                {
                    Mc.Add("Cluster is in Adapted mode (6).");
                }

                Mc.Add("Toggling cluster mode...");
